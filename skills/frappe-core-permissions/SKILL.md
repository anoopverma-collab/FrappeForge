...
5. **v16+**: ALWAYS return `True` in `has_permission` hooks to allow access.
   **v14/v15**: ALWAYS return `None` by default to defer to core logic.
...
| `return True` (v16+) | `return True` |
| `return None` (v14/v15) | `return None` |
