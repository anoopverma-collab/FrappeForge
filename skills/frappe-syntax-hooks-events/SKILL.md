...
| Feature | v14 | v15 | v16 |
|---|---|---|---|
| `doc_events` in `hooks.py` | Stable | Stable | Stable |
| `frappe.db.commit()` in hooks | Discouraged | Discouraged | **Blocked/Restricted** |
| `extend_doctype_class` | No | No | **Yes (Preferred)** |
| `override_doctype_class` | Supported | Supported | Supported (Legacy) |
