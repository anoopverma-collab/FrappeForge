...
def get_data(filters):
    ...
    return frappe.db.sql("""
        ...
        ORDER BY total DESC
    """.replace("{conditions}", conditions), filters, as_dict=True)
...
| Feature | v14 | v15 | v16 |
|---|---|---|---|
| `get_list` Backend | SQL-based | SQL-based | **Query Builder (PyPika)** |
| Aggregate Syntax | SQL strings | SQL strings | **Dict-based (v16+)** |
| JS Scoping | Global scope | Global scope | **IIFE (Local scope)** |
| `prepared_report` | Supported | Supported | Supported |
| Charting Engine | Frappe Charts | Frappe Charts | Frappe Charts |
