...
| Feature | v14 | v15 | v16 |
|---|---|---|---|
| `frm.set_value()` | Stable | Stable | Stable |
| `frappe.call` (async/await) | Supported | Supported | Supported |
| `frm.is_new()` | Supported | Supported | Supported |
| Child Table `cdt/cdn` | Stable | Stable | Stable |
| UI/Bootstrap | v4 | **v5** | v5 |
